...
# For development only - use a proper secret key in production
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-your-secret-key-here")   #i have changed this part 
